...
import { User, Lock, Mail, GraduationCap, Users, Shield, ArrowLeft, Eye, EyeOff } from 'lucide-react';
...
const SignUpPage = () => {
    ...
    return (
        <div className="min-h-screen bg-white flex items-center justify-center p-4 pt-24 md:p-4 relative overflow-hidden">
            ...
            {/* Decorative elements */}
            <motion.div
                className="absolute top-20 right-10 w-16 h-16 bg-[#B9FF66] rounded-full opacity-40"
                animate={{ y: [0, -20, 0], scale: [1, 1.1, 1] }}
                transition={{ duration: 4, repeat: Infinity, ease: "easeInOut" }}
            />
            <motion.div
                className="absolute bottom-20 left-10 w-12 h-12 bg-[#B9FF66] rounded-lg rotate-12 opacity-40"
            ...
            <div className="max-w-6xl w-full relative z-10">
                <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
                    ...
                    >
                        ...
                        <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold font-geist text-[#191A23] mb-6 leading-tight">
                            Start Your{' '}
                            <span className="bg-[#B9FF66] px-3 py-1 rounded-lg inline-block">Journey</span>
                        </h1>
                        <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                            Join thousands of learners and unlock your potential with interactive courses and expert mentors.
                        </p>

                        {/* Benefits list */}
                        <div className="space-y-3 hidden md:block">
                            {['Access to all courses', 'Expert mentor support', 'Progress tracking'].map((benefit, idx) => (
                                <motion.div
                                    key={idx}
                                ...
                                >
                                    ...
                                    <span className="text-[#191A23] font-medium">{benefit}</span>
                                </motion.div>
                            ))}
                        </div>
                    </motion.div>
                    ...
                    >
                        <div className="bg-white border-2 border-[#191A23] rounded-[32px] p-8 md:p-10 shadow-[0_8px_0_#191A23]">
                            ...
                            <p className="text-gray-600 mb-8">Choose your role and get started</p>
                            ...
                            <form onSubmit={handleSignUp} className="space-y-4">
                                ...
                                <div className="flex items-start gap-2 text-sm pt-2">
                                    <input type="checkbox" className="w-4 h-4 mt-0.5 rounded border-2 border-[#191A23] text-[#B9FF66] focus:ring-[#B9FF66]" required />
                            ...
                            <div className="mt-6 text-center">
                                <p className="text-gray-600">
                                    ...
                                    <a href="/login" className="text-[#191A23] font-bold hover:text-[#B9FF66] transition-colors">
                                        Sign In
                                    </a>
                                </p>
                            </div>
